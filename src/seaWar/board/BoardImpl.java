...
class BoardImpl implements Board, BoardViewAccess, Shot {
  ...
  BoardImpl(Game game, FieldStatus initialStatus) {
    ...
    // initialized any filed with water
   ...
   * change, report WATER (a second hit is water) (4) SHOT_ON_WATER hit: no field status change,
   * report WATER
   *
   * @param column
   * @param row
  ...
  public ShotResults shot(int column, int row) throws GameStatusException,
    ...
    switch (status) {
      ...
      case UNKNOWN:
        ...
        // this case must be overwritten in RemoteBoard
