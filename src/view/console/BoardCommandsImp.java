...
public class BoardCommandsImp implements BoardCommands {
  ...
  public BoardCommandsImp(Game game, PrintStream os, InputStream is) {
    this.game = game;
  ...
  public static void main(String[] args) {
    ...
    os.println("Welcome to Sea War V 0.1");
    BoardCommandsImp userCmd = new BoardCommandsImp(
        game, os, System.in);
      ...
      try {
        ...
        switch (commandString) {
          ...
          case PRINT_REMOTE:
            ...
            break;
          case SHOT:
            this.doShot(parameterString);
            break;
          case SET_SHIP:
            this.doSetShip(parameterString);
            break;
          case REMOVE_SHIP:
            this.doRemoveShip(parameterString);
            break;
          case START_GAME:
            this.doStartGame();
            break;
          ...
          default:
            this.consoleOutput.println("unknown command:" +
                cmdLineString);
            this.printUsage();
            break;
        }
  ...
  private void doShot(String parameterString) throws BoardException {
    ...
    try {
      ...
      switch (shot) {
        case HIT:
          this.consoleOutput.println(HIT_STRING);
          break;
        ...
        case HIT_WATER:
          this.consoleOutput.println(HIT_WATER_STRING);
          break;
      }
